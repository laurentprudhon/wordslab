using System;
using wordslab.documents.html;

namespace wordslab.documents
{
    class Program
    {
        ...
        static void PrintUsage()
        {
            ...
            Console.WriteLine("The .nlp.txt file format is described here : https://github.com/laurentprudhon/nlptextdoc");
            Console.WriteLine();
